...
void main() {
    ...
    // ondulation permanente on hover
    newposition.z += hoverState*10.*sin(dist*20. + time/4.);
    
    // gaussienne
    // newposition.z += hoverState*100.*exp((dist-5.)*(dist-0.05));
...
// for fragment.glsl
    ...
    vNoise = hoverState*exp((dist-5.)*(dist-0.2));
